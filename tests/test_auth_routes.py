...
def test_session_persists_across_requests(auth_client, sample_user):
...
def test_session_expires_after_logout(auth_client, sample_user):
...
def test_malformed_form_data(auth_client):
...
def test_very_large_form_data(auth_client):
