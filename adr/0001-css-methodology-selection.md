...
```
yak_shears/static/css/
├── main.css                 /* Base styles and imports */
├── files-list.css           /* Files list component */
├── editor.css               /* Editor component */
└── [future].css             /* New components */
```

### Implementation Example

HTML Structure (files_list.html.jinja):

<div class="files-list">
    <div class="files-list__cards-container">
        <a href="/edit?file={{ info.path }}" class="files-list__card-link">
            <div class="files-list__card">
                <p class="files-list__card-preview">{{ info.preview }}</p>
                <div class="files-list__pills">
                    <span class="files-list__pill files-list__pill--recent">
                        {{ info.last_modified[:10] }}
                    </span>
                </div>
            </div>
        </a>
...
/* Element: card preview text */
.files-list__card-preview {
    margin: 0 0 10px 0;
    color: #555;
}

/* Element: pills container */
.files-list__pills {
    display: flex;
    gap: 8px;
    flex-wrap: wrap;
...
/* Modifier: recent pill variant */
.files-list__pill--recent {
